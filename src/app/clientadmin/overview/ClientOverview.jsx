...
export default function ClientOverview() {
  ...
  return (
    <div className="flex flex-col gap-6 pb-12 animate-in fade-in duration-200 bg-[var(--bg-main)] min-h-full text-slate-100">
        ...
        <div className="flex flex-col gap-4">
          <div>
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-semibold text-slate-300 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl hover:bg-[var(--bg-card-hover)] hover:text-white transition-colors shadow-xs cursor-pointer"
            >
